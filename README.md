# Available .PINK One-Word Domains (5,621,924)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-9%2C195%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-5%2C621%2C924%20domains-6f42c1">
...
> **Important:** this repository is a **public 9,195-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,621,924 domains** on the canonical page below.

**Public extract:** 9,195 rows · **Live catalog:** 5,621,924 domains
...
<p align="center">
  ...
  <a href="https://unique.domains/domains/tld/pink?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_pink_oneword_domains&utm_content=top_create_radar"><b>🔔 Create Radar</b></a> ·
  <a href="https://unique.domains/domains/tld/pink?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_pink_oneword_domains&utm_content=top_start_project"><b>🚀 Start a Project</b></a> ·
  <b>⬇️ Download sample</b>: <a href="./pink.csv">CSV</a> / <a href="./pink.json">JSON</a>
</p>

<p align="center">
  <a href="https://unique.domains/technology?utm_source=github&utm_medium=referral&utm_campaign=repo_pink_oneword_domains&utm_content=top_methodology">Methodology</a> ·
  <a href="https://unique.domains/api?utm_source=github&utm_medium=referral&utm_campaign=repo_pink_oneword_domains&utm_content=top_api_docs">API docs</a>
</p>
...
- **Investors:** [Create a Radar from this exact .PINK search](https://unique.domains/domains/tld/pink?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_pink_oneword_domains&utm_content=top_create_radar)
- **Founders:** [Start a Project from this exact .PINK search](https://unique.domains/domains/tld/pink?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_pink_oneword_domains&utm_content=top_start_project)
- **Researchers / builders:** [Download CSV](./pink.csv) or [Download JSON](./pink.json)
...
- `pink.csv` — public CSV extract (9,195 rows)
- `pink.json` — public JSON extract (9,195 rows)
...
| ----------------------- | ------------------------------------------------ |
| 9,195-row public sample | 5,621,924 live domains                           |
...
| ------------- | --------- | --------- | ------------- | -------------- | ------ | ------ | ----------------------- |
| fortune.pink  | available | $14.99    | —             | 72             | 53     | 7      | name.com                |
| trade.pink    | resell    | $31.48    | —             | 116            | 46     | 5      | GoDaddy.com, LLC        |
| easy.pink     | premium   | $14.99    | $37.99        | 128            | 62     | 4      | name.com                |
| genius.pink   | available | $14.99    | $37.99        | 98             | 47     | 6      | name.com                |
...
| gold.pink     | premium   | $1,300    | $1,300        | 72             | 49     | 4      | namecheap               |
...
| research.pink | available | $31.48    | —             | 92             | 41     | 8      | namecheap               |
| discover.pink | resell    | —         | —             | 66             | 75     | 8      | NameCheap, Inc.         |
| health.pink   | premium   | $1,300    | $1,300        | 92             | 45     | 6      | namecheap               |
| banana.pink   | available | $14.99    | —             | 86             | 41     | 6      | name.com                |
| hello.pink    | resell    | —         | —             | 130            | 71     | 5      | Porkbun LLC             |
...
> Unique Domains. *Available .PINK One-Word Domains*. Version 2026-04-09. Public GitHub extract for the exact Unique Domains search represented by this repository.
